    ...
    private fun setupTabsAndPager(codes: List<CodeEntity>) {
        ...
        binding.viewPager.addOnPageChangeListener(object :
            ...
            override fun onPageSelected(position: Int) {
                ...
                viewModel.currentNameAndCodeLiveData.postValue(listOf(codes[position].name, codes[position].codes))
            }
        })
        binding.tabLayout.addOnTabSelectedListener(object :
            ...
            override fun onTabSelected(tab: TabLayout.Tab) {
                ...
                viewModel.currentNameAndCodeLiveData.postValue(listOf(codes[tab.position].name, codes[tab.position].codes))
            }
        })
    }
